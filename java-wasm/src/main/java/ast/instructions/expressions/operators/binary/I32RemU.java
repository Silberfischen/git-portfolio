 ...
 * TODO documentation
 */
public class I32RemU extends AbstractBinaryOperator<Integer> {

    public I32RemU(AbstractExpression<Integer> firstOperand,
    ...
    public Integer evaluate(ExecutionStack executionStack) {
        return Math
            .abs(firstOperand.evaluate(executionStack) % secondOperand.evaluate(executionStack));
    }
}
